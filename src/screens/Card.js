   ...
   <View style={styles.mainContainer}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.upper}>
          <RNText style={[externalStyles.txtXl,{color:colors.white , textAlign:"right"}]} fontWeight='SemiBold'>VISA</RNText>
        </View>

        <View style={styles.bottom}>
          <View style={styles.numbers}>
            <RNText style={[externalStyles.txtXl,{color:colors.white }]}  fontWeight='SemiBold' >4716</RNText>
            <RNText style={[externalStyles.txtXl,{color:colors.white }]}  fontWeight='SemiBold'>9627</RNText>
            <RNText style={[externalStyles.txtXl,{color:colors.white }]}  fontWeight='SemiBold'>1635</RNText>
            <RNText style={[externalStyles.txtXl,{color:colors.white }]}  fontWeight='SemiBold'>8074</RNText>
          </View>

          < View style={styles.text}>
            <View>
              <RNText style={{color:colors.white}}>Card Holder Name</RNText>
            ...
            <View >
              <Img source={credit} width={53} height={53} style={{marginBottom:20}}/>
            </View>
          </View>
      ...
      <View style={{flexDirection: 'row',alignItems: 'center',gap:15,}} >
        <View style={styles.tickBox}>
          <Img source={tick} width={19} height={14} style={styles.tick}/>
        </View>
        <RNText style={externalStyles.txtMd} fontWeight='SemiBold'>Save Card</RNText>
      </View>

      <View style={{gap:5}}>
        <View>
          <RNText style={externalStyles.txtMd} fontWeight='SemiBold'>Saved Cards</RNText>
          <RNText style={externalStyles.txtXs}>List of all credit cards you saved</RNText>
        </View>
        ...
        <View>
            <RNView style={styles.visa}>
              <View style={styles.leftSide}>
                <View style={styles.imgContainer}>
                  <Img source={visa} width={32} height={10} style={styles.imgVisa} />
                </View>
                <View>
           ...
           <View>
            <RNView style={styles.visa}>
              <View style={styles.leftSide}>
                <View style={styles.imgContainer}>
                  <Img source={master} width={26} height={17} style={styles.imgMaster} />
                </View>
                <View>
                  <RNText style={externalStyles.txtMd} fontWeight='semiBold'>
