    ...
    <View style ={styles.mainContainer}>
      <View style={styles.top}>
        ...
        <View style={styles.textContainer}>
          <RNText style={externalStyles.txtLg} color="primary" fontWeight="bold">Address</RNText>
        </View>
      </View>

      <RNView style={styles.searchBar}>
          <Img source={choose} width={16} height={16} />
          <RNText color='primary' style={externalStyles.txtMd}>Find an Address</RNText>
      </RNView>

      <View style={styles.textMiddle}>
        <RNText fontWeight='semiBold' style={externalStyles.txtMd}>Saved addresses</RNText>
      ...
      <View style={styles.addressContainer}>
        ...
        <RNView style={styles.addressCard}>
          <View style={styles.top}>
            <View style={styles.Img}>
               <Img source={ellipse} width={36} height={36} style={styles.outer}/>
               <Img source={office} width={25} height={20} style={styles.inner}/>
            </View>
            <RNText style={externalStyles.txtMd} fontWeight='semiBold'>Office</RNText>
          </View>
        ...
        <RNView style={[styles.addressCard,styles.border]}>
          <View style={styles.top}>
            <View style={styles.Img}>
               <Img source={borderEllipse} width={36} height={36} style={styles.outer}/>
               <Img source={home} width={25} height={20} style={styles.inner}/>
            </View>
            <RNText style={externalStyles.txtMd} fontWeight='semiBold'>Home</RNText>
          </View>
          <View style={styles.bottom}>
            <View style={styles.text}>
              <RNText>OASIS CENTER MALL, OFFICE</RNText>
